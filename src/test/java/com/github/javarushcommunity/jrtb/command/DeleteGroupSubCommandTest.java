...
public class DeleteGroupSubCommandTest {
    ...
    @BeforeEach
    public void init() {
        botMessageService = Mockito.mock(SendBotMessageService.class);
        groupSubService = Mockito.mock(GroupSubService.class);
        telegramUserService = Mockito.mock(TelegramUserService.class);

        command = new DeleteGroupSubCommand(botMessageService,
    ...
    public void shouldProperlyReturnEmptySubscriptionList() {
        ...
        //then
        Mockito.verify(botMessageService).sendMessage(chatId, expectedMessage);
    }
    ...
    @Test
    public void shouldRejectByInvalidId() {
        //given
        Long chatId = 23456L;
    ...
    public void shouldProperlyDeleteByGroupId() {
        ...
        Update update = prepareUpdate(chatId,
                String.format("%s %s", DELETE_GROUP_SUB.getCommandName(), groupId));
    ...
    @Test
    public void shouldNotExistGivenByGroupId() {
        //given
        Long chatId = 23456L;
        Integer groupId = 1234;
        Update update = prepareUpdate(chatId,
